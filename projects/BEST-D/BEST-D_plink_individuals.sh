...
plink2 --noweb --bfile P140343-Results_FinalReport --check-sex --out P140343-Results_FinalReport

#Produce a list of individuals with discordant sex data:

grep PROBLEM P140343-Results_FinalReport.sexcheck > gender_mis-identification_check.FAILED_QC
...
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome --missing --out P140343-Results_FinalReport_clean_SNPs_autosome
...
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome --het --out P140343-Results_FinalReport_clean_SNPs_autosome
...
Rscript imiss-vs-het_modified.R P140343-Results_FinalReport_clean_SNPs_autosome
...
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome --indep-pairwise 50 5 0.2
...
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome --extract plink.prune.in --genome \
	--out P140343-Results_FinalReport_clean_SNPs_autosome_pruned
...
ln -s P140343-Results_FinalReport_clean_SNPs_autosome_pruned.genome P140343-Results_FinalReport_clean_SNPs_autosome.genome
...
Rscript plot-IBD_modified.R P140343-Results_FinalReport_clean_SNPs_autosome
...
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome --extract hapmap3r2_CEU.CHB.JPT.YRI.no-at-cg-snps.txt --make-bed \
	--out P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps


# (b) Merge the raw-GWA-data.hapmap-snps files with the HapMap data and extract the pruned SNP set:

plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps \
	--bmerge hapmap3r2_CEU.CHB.JPT.YRI.founders.no-at-cg-snps \
	--extract plink.prune.in --make-bed --out P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned
...
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome --extract hapmap3r2_CEU.CHB.JPT.YRI.no-at-cg-snps.txt \
	--flip P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned-merge.missnp --make-bed \
	--out P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps

#Then re-run (b) (the --bmerge command) exactly as above:
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps --bmerge hapmap3r2_CEU.CHB.JPT.YRI.founders.no-at-cg-snps \
	--extract plink.prune.in --make-bed --out P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned


#Create a copy of the output BIM and FAM files just generated:
cp P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.bim \
	P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.pedsnp

cp P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.fam \
	P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.pedind

#Conduct a PCA on the merged data (requires smartpca.perl from EIGENSOFT, see dependencies above). Files are from the previous output 
#plus 'pca-populations.txt' file that specifies populations columns:
 
smartpca.perl -i P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.bed \
        -a P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.pedsnp \
        -b P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.pedind \
        -o P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.pca \
        -p P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.plot \
        -e P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.eval \
        -l P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_hapmap3r2.pruned.log \
...
Rscript plot-pca-results_modified.R P140343-Results_FinalReport_clean_SNPs_autosome.Anderson_hapmap_snps_
...
plink2 --noweb --bfile P140343-Results_FinalReport_clean_SNPs_autosome --remove FAILED-QC-INDIVIDUALS.txt --make-bed \
...
plink2 --bfile P140343-Results_FinalReport_clean_SNPs_autosome_individuals --freq --out P140343-Results_FinalReport_clean_SNPs_autosome_individuals
plink2 --bfile P140343-Results_FinalReport_clean_SNPs_autosome_individuals --freqx --out P140343-Results_FinalReport_clean_SNPs_autosome_individuals

# Get frequency report for SNPs of interest:
grep -wf VD_SNPs_GWAS_list.txt P140343-Results_FinalReport_clean_SNPs_autosome_individuals.frq > \
        VD_SNPs_GWAS_list_in_BESTD.frq

grep -wf VD_SNPs_GWAS_list.txt P140343-Results_FinalReport_clean_SNPs_autosome_individuals.frqx > \
	VD_SNPs_GWAS_list_in_BESTD.frqx
