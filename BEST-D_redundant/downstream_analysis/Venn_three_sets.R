...
####################
# Set labels:
title_Venn <- sprintf('Shared and unique %ss at %s < %s', column_file1, col_adj_pvalue, adj_pvalue)
title_Venn
...
####################
# Draw Venn diagram:
png(sprintf('venn-%s-%s-VS-%s-VS-%s.png', column_file1, hits_file1, hits_file2, hits_file3))
