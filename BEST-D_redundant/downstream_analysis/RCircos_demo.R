# This demo draw human chromosome ideogram and then data tracks for:
#       1.  Connectors
#       2.  Gene labels
#       3.  Heatmap
#       4.  Scatterplot 
...
#       8.  Link lines
#       9.  Ribbons
# These are in order (1 is closest to ideogram which is the outer ring, can be customised).
...
RCircos.Histogram.Plot(hist.data=RCircos.Histogram.Data, data.col=4, track.num=8, side="in")
...
RCircos.Link.Plot(link.data=RCircos.Link.Data, track.num=11, by.chromosome=FALSE)
