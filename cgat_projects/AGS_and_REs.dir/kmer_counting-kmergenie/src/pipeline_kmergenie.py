...
Example data is available at http://www.cgat.org/~andreas/sample_data/pipeline_kmergenie.tgz.
To run the example, simply unpack and untar::

   wget http://www.cgat.org/~andreas/sample_data/pipeline_kmergenie.tgz
   tar -xvzf pipeline_kmergenie.tgz
   cd pipeline_kmergenie
   python <srcdir>/pipeline_kmergenie.py make full
...
@transform('*.gz', suffix('.gz'), '.histograms')
def runKmerGenie(infile, outfile):
