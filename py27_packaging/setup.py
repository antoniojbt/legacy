...
setup(
      ...
      name = 'py27_packaging',
      version = '0.1.1',
      url = 'https://github.com/AntonioJBT/py27_packaging',
      download_url = 'https://github.com/AntonioJBT/py27_packaging.git',
...
#      package_dir = {'' : 'py27_packaging'},
      scripts = ['py27_packaging/py27_main.py'],
      #entry_points = {'console_scripts': [ 'py27_packaging.py = py27_packaging:main' ]},
      zip_safe = False,
          )
